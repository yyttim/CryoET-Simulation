...
'Tb': ((0.188235, 1, 0.780392), 1, u'default'), 'Tc': ((0.231373, 0.619608, 0.619608), 1, u'default'), 'Ta': ((0.301961, 0.65098, 1), 1, u'default'), 'Yb': ((0, 0.74902, 0.219608), 1, u'default'), 'Db': ((0.819608, 0, 0.309804), 1, u'default'), 'Dy': ((0.121569, 1, 0.780392), 1, u'default'), 'At': ((0.458824, 0.309804, 0.270588), 1, u'default'), 'I': ((0.580392, 0, 0.580392), 1, u'default'), 'U': ((0, 0.560784, 1), 1, u'default'), 'Y': ((0.580392, 1, 1), 1, u'default'), 'Ac': ((0.439216, 0.670588, 0.980392), 1, u'default'), 'Ag': ((0.752941, 0.752941, 0.752941), 1, u'default'), 'Ir': ((0.0901961, 0.329412, 0.529412), 1, u'default'), 'Am': ((0.329412, 0.360784, 0.94902), 1, u'default'), 'Al': ((0.74902, 0.65098, 0.65098), 1, u'default'), 'As': ((0.741176, 0.501961, 0.890196), 1, u'default'), 'Ar': ((0.501961, 0.819608, 0.890196), 1, u'default'), 'Au': ((1, 0.819608, 0.137255), 1, u'default'), 'Es': ((0.701961, 0.121569, 0.831373), 1, u'default'), 'In': ((0.65098, 0.458824, 0.45098), 1, u'default'), 'Mo': ((0.329412, 0.709804, 0.709804), 1, u'default')}
	...
	viewerInfo = {'cameraAttrs': {'center': (275, 275, 275), 'fieldOfView': 16.561310471608, 'nearFar': (702.46718693298, -88.370148882452), 'ortho': False, 'eyeSeparation': 50.8, 'focal': 275}, 'viewerAttrs': {'silhouetteColor': None, 'clipping': False, 'showSilhouette': False, 'showShadows': False, 'viewSize': 347.38091922006, 'labelsOnTop': True, 'depthCueRange': (0.5, 1), 'silhouetteWidth': 2, 'singleLayerTransparency': True, 'shadowTextureSize': 2048, 'backgroundImage': [None, 1, 2, 1, 0, 0], 'backgroundGradient': [('Chimera default', [(1, 1, 1, 1), (0, 0, 1, 1)], 1), 1, 0, 0], 'depthCue': True, 'highlight': 0, 'scaleFactor': 1.1819089897831, 'angleDependentTransparency': True, 'backgroundMethod': 0}, 'viewerHL': 2, 'cameraMode': 'mono', 'detail': 1.5, 'viewerFog': None, 'viewerBG': 1}
      ...
      [
       {
        ...
        'session_volume_id': 'Ad-??N,\\>@\tDt+!<>MjTK\n"6KI^|z\x0b$\'',
        ...
        'surface_levels': [ 41.20967230833397, ],
        'surface_model': {
          'active': True,
          'class': 'Model_State',
          ...
          'xform': {
            'class': 'Xform_State',
            'rotation_angle': 143.75248592237517,
            'rotation_axis': ( 0.6742646978546579, -0.7060276627515195, -0.21654573802454194, ),
            'translation': ( 300.7289987341777, 266.2186762763412, 321.2035037579587, ),
            'version': 1,
           },
         },
     ...
     (
      {
       ...
       'file_type': 'mrc',
       'grid_id': '',
       'name': '5vai_mbz_align.mrc',
       'path': '5vai_mbz_align.mrc',
       'rotation': (
         ( 1, 0, 0, ),
         ( 0, 1, 0, ),
         ( 0, 0, 1, ),
      ...
      [
       {
        ...
        'representation': 'surface',
        'session_volume_id': 'b58e?gzX^d#T)hy)`]-8=w#?6 G/,N0K',
        'solid_brightness_factor': 1.0,
        'solid_colors': [
          ( 1, 1, 0.7, 1, ),
          ( 1, 1, 0.7, 1, ),
        ...
        'surface_model': {
          ...
          'xform': {
            'class': 'Xform_State',
            'rotation_angle': 93.28412394003779,
            'rotation_axis': ( -0.9999599231824605, -0.007495766812972919, -0.004895457977887436, ),
            'translation': ( 27.929428926459128, 15.37941723426641, 593.8410198700163, ),
            'version': 1,
           },
         },
        'transparency_depth': 0.5,
     ...
     (
      {
       ...
       'file_type': 'mrc',
       'grid_id': '',
       'name': '5vai_mb_ref.mrc',
       'path': '5vai_mb_ref.mrc',
       'rotation': (
         ( 1, 0, 0, ),
         ( 0, 1, 0, ),
         ( 0, 0, 1, ),
      ...
      [
       {
        ...
        'representation': 'surface',
        'session_volume_id': 'qI_\\,\x0c n#b|Ct\n6eBM}V[;LC0Wc-:YdZ',
 ...
 volume_dialog_state = \
  {
   ...
   'data_cache_size': '512',
   'focus_volume': 'b58e?gzX^d#T)hy)`]-8=w#?6 G/,N0K',
   'geometry': u'407x440+1208+107',
   'histogram_active_order': [ 2, 1, 0, ],
   'histogram_volumes': [ 'qI_\\,\x0c n#b|Ct\n6eBM}V[;LC0Wc-:YdZ', 'Ad-??N,\\>@\tDt+!<>MjTK\n"6KI^|z\x0b$\'', 'b58e?gzX^d#T)hy)`]-8=w#?6 G/,N0K', ],
   'immediate_update': 1,
   'initial_colors': (
     ( 0.7, 0.7, 0.7, 1, ),
     ( 1, 1, 0.7, 1, ),
