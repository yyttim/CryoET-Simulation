...
'Tb': ((0.188235, 1, 0.780392), 1, u'default'), 'Tc': ((0.231373, 0.619608, 0.619608), 1, u'default'), 'Ta': ((0.301961, 0.65098, 1), 1, u'default'), 'Yb': ((0, 0.74902, 0.219608), 1, u'default'), 'Db': ((0.819608, 0, 0.309804), 1, u'default'), 'Dy': ((0.121569, 1, 0.780392), 1, u'default'), 'At': ((0.458824, 0.309804, 0.270588), 1, u'default'), 'I': ((0.580392, 0, 0.580392), 1, u'default'), 'U': ((0, 0.560784, 1), 1, u'default'), 'Y': ((0.580392, 1, 1), 1, u'default'), 'Ac': ((0.439216, 0.670588, 0.980392), 1, u'default'), 'Ag': ((0.752941, 0.752941, 0.752941), 1, u'default'), 'Ir': ((0.0901961, 0.329412, 0.529412), 1, u'default'), 'Am': ((0.329412, 0.360784, 0.94902), 1, u'default'), 'Al': ((0.74902, 0.65098, 0.65098), 1, u'default'), 'As': ((0.741176, 0.501961, 0.890196), 1, u'default'), 'Ar': ((0.501961, 0.819608, 0.890196), 1, u'default'), 'Au': ((1, 0.819608, 0.137255), 1, u'default'), 'Es': ((0.701961, 0.121569, 0.831373), 1, u'default'), 'In': ((0.65098, 0.458824, 0.45098), 1, u'default'), 'Mo': ((0.329412, 0.709804, 0.709804), 1, u'default')}
	...
	viewerInfo = {'cameraAttrs': {'center': (295, 295, 295), 'fieldOfView': 16.561310471608, 'nearFar': (739.89907887608, -107.71925608486), 'ortho': False, 'eyeSeparation': 50.8, 'focal': 295}, 'viewerAttrs': {'silhouetteColor': None, 'clipping': False, 'showSilhouette': False, 'showShadows': False, 'viewSize': 519.61524227066, 'labelsOnTop': True, 'depthCueRange': (0.5, 1), 'silhouetteWidth': 2, 'singleLayerTransparency': True, 'shadowTextureSize': 2048, 'backgroundImage': [None, 1, 2, 1, 0, 0], 'backgroundGradient': [('Chimera default', [(1, 1, 1, 1), (0, 0, 1, 1)], 1), 1, 0, 0], 'depthCue': True, 'highlight': 0, 'scaleFactor': 1.9513543635097, 'angleDependentTransparency': True, 'backgroundMethod': 0}, 'viewerHL': 2, 'cameraMode': 'mono', 'detail': 1.5, 'viewerFog': None, 'viewerBG': 1}
     ...
     (
      {
       ...
       'file_type': 'mrc',
       'grid_id': '',
       'name': '5wek_mb_zalign.mrc',
       'path': '5wek_mb_zalign.mrc',
       'rotation': (
         ( 1, 0, 0, ),
         ( 0, 1, 0, ),
         ( 0, 0, 1, ),
      ...
      [
       {
        ...
        'surface_levels': [ 40.714501936430075, ],
        'surface_model': {
          'active': True,
          'class': 'Model_State',
          ...
          'xform': {
            'class': 'Xform_State',
            'rotation_angle': 50.96355031256319,
            'rotation_axis': ( 0.0009614482507485976, -0.00597663841276191, 0.9999816775374157, ),
            'translation': ( 361.5993969218668, -119.93784133041416, 20.051792796166986, ),
            'version': 1,
           },
         },
      ...
      [
       {
        ...
        'representation': 'surface',
        'session_volume_id': 'f=_#UPYVlGnqKjbf|u)4d<^UQ*N|B:wF',
        'solid_brightness_factor': 1.0,
        'solid_colors': [
          ( 1, 1, 0.7, 1, ),
          ( 1, 1, 0.7, 1, ),
        ...
        'surface_model': {
          ...
          'xform': {
            'class': 'Xform_State',
            'rotation_angle': 60.355480643905054,
            'rotation_axis': ( 0.03767825342994822, 0.2201754658760785, 0.9747323291266792, ),
            'translation': ( 303.5205939118844, 290.2075010282841, 343.3212411488277, ),
            'version': 1,
           },
         },
        'transparency_depth': 0.5,
     ...
     (
      {
       ...
       'file_type': 'mrc',
       'grid_id': '',
       'name': '5wek_mb_ref.mrc',
       'path': '5wek_mb_ref.mrc',
       'rotation': (
         ( 1, 0, 0, ),
         ( 0, 1, 0, ),
         ( 0, 0, 1, ),
      ...
      [
       {
        ...
        'representation': 'surface',
        'session_volume_id': 'l2u0)>ipq}#V\\R9a\tEi{*VTO.}+54RZ\t',
        'solid_brightness_factor': 1.0,
        'solid_colors': [
          ( 1.0, 1.0, 1.0, 1, ),
          ( 1.0, 1.0, 1.0, 1, ),
 ...
 volume_dialog_state = \
  {
   ...
   'histogram_volumes': [ 'l2u0)>ipq}#V\\R9a\tEi{*VTO.}+54RZ\t', 'f=_#UPYVlGnqKjbf|u)4d<^UQ*N|B:wF', 'v\n:a-t\\;z:_xzbU7yb6grRd_x00b\tW\t:', ],
   'immediate_update': 1,
   'initial_colors': (
     ( 0.7, 0.7, 0.7, 1, ),
     ( 1, 1, 0.7, 1, ),
