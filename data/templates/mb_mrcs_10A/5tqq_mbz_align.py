...
'Tb': ((0.188235, 1, 0.780392), 1, u'default'), 'Tc': ((0.231373, 0.619608, 0.619608), 1, u'default'), 'Ta': ((0.301961, 0.65098, 1), 1, u'default'), 'Yb': ((0, 0.74902, 0.219608), 1, u'default'), 'Db': ((0.819608, 0, 0.309804), 1, u'default'), 'Dy': ((0.121569, 1, 0.780392), 1, u'default'), 'At': ((0.458824, 0.309804, 0.270588), 1, u'default'), 'I': ((0.580392, 0, 0.580392), 1, u'default'), 'U': ((0, 0.560784, 1), 1, u'default'), 'Y': ((0.580392, 1, 1), 1, u'default'), 'Ac': ((0.439216, 0.670588, 0.980392), 1, u'default'), 'Ag': ((0.752941, 0.752941, 0.752941), 1, u'default'), 'Ir': ((0.0901961, 0.329412, 0.529412), 1, u'default'), 'Am': ((0.329412, 0.360784, 0.94902), 1, u'default'), 'Al': ((0.74902, 0.65098, 0.65098), 1, u'default'), 'As': ((0.741176, 0.501961, 0.890196), 1, u'default'), 'Ar': ((0.501961, 0.819608, 0.890196), 1, u'default'), 'Au': ((1, 0.819608, 0.137255), 1, u'default'), 'Es': ((0.701961, 0.121569, 0.831373), 1, u'default'), 'In': ((0.65098, 0.458824, 0.45098), 1, u'default'), 'Mo': ((0.329412, 0.709804, 0.709804), 1, u'default')}
	...
	viewerInfo = {'cameraAttrs': {'center': (265, 265, 265), 'fieldOfView': 16.561310471608, 'nearFar': (614.9597915909, -147.50686368254), 'ortho': False, 'eyeSeparation': 50.8, 'focal': 265}, 'viewerAttrs': {'silhouetteColor': None, 'clipping': False, 'showSilhouette': False, 'showShadows': False, 'viewSize': 334.74888579387, 'labelsOnTop': True, 'depthCueRange': (0.5, 1), 'silhouetteWidth': 2, 'singleLayerTransparency': True, 'shadowTextureSize': 2048, 'backgroundImage': [None, 1, 2, 1, 0, 0], 'backgroundGradient': [('Chimera default', [(1, 1, 1, 1), (0, 0, 1, 1)], 1), 1, 0, 0], 'depthCue': True, 'highlight': 0, 'scaleFactor': 1.6510191396953, 'angleDependentTransparency': True, 'backgroundMethod': 0}, 'viewerHL': 2, 'cameraMode': 'mono', 'detail': 1.5, 'viewerFog': None, 'viewerBG': 1}
      ...
      [
       {
        ...
        'session_volume_id': 'T`Cf:b}j3MU`7)/:\x0byOd)Mr:<KE\\{5][',
        ...
        'surface_levels': [ 62.592722822028364, ],
        'surface_model': {
          'active': True,
          'class': 'Model_State',
          ...
          'xform': {
            'class': 'Xform_State',
            'rotation_angle': 166.75308867088663,
            'rotation_axis': ( 0.07075850751479097, 0.9952661059264388, -0.06662290903512051, ),
            'translation': ( 220.29584186013602, 233.57647004030153, 238.84788200709016, ),
            'version': 1,
           },
         },
     ...
     (
      {
       ...
       'file_type': 'mrc',
       'grid_id': '',
       'name': '5tqq_mbz_align.mrc',
       'path': '5tqq_mbz_align.mrc',
       'rotation': (
         ( 1, 0, 0, ),
         ( 0, 1, 0, ),
         ( 0, 0, 1, ),
      ...
      [
       {
        ...
        'representation': 'surface',
        'session_volume_id': '![+ts}%VnRj^+ABPI /JfPYETC(S++Uw',
        'solid_brightness_factor': 1.0,
        'solid_colors': [
          ( 1, 1, 0.7, 1, ),
          ( 1, 1, 0.7, 1, ),
        ...
        'surface_model': {
          ...
          'xform': {
            'class': 'Xform_State',
            'rotation_angle': 121.98778991427915,
            'rotation_axis': ( -0.566820542283424, 0.5915401745156563, 0.5734062214342568, ),
            'translation': ( 495.3415745687389, -2.8509958719906874, 495.4303659914977, ),
            'version': 1,
           },
         },
        'transparency_depth': 0.5,
     ...
     (
      {
       ...
       'file_type': 'mrc',
       'grid_id': '',
       'name': '5tqq_mb_ref.mrc',
       'path': '5tqq_mb_ref.mrc',
       'rotation': (
         ( 1, 0, 0, ),
         ( 0, 1, 0, ),
         ( 0, 0, 1, ),
      ...
      [
       {
        ...
        'representation': 'surface',
        'session_volume_id': 'ogS9/iSH,rom]OWJ U:pDdd-?Wt<dWsD',
 ...
 volume_dialog_state = \
  {
   ...
   'data_cache_size': '512',
   'focus_volume': '![+ts}%VnRj^+ABPI /JfPYETC(S++Uw',
   'geometry': u'407x440+1208+107',
   'histogram_active_order': [ 2, 1, 0, ],
   'histogram_volumes': [ 'ogS9/iSH,rom]OWJ U:pDdd-?Wt<dWsD', 'T`Cf:b}j3MU`7)/:\x0byOd)Mr:<KE\\{5][', '![+ts}%VnRj^+ABPI /JfPYETC(S++Uw', ],
   'immediate_update': 1,
   'initial_colors': (
     ( 0.7, 0.7, 0.7, 1, ),
     ( 1, 1, 0.7, 1, ),
