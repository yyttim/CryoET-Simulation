...
'Tb': ((0.188235, 1, 0.780392), 1, u'default'), 'Tc': ((0.231373, 0.619608, 0.619608), 1, u'default'), 'Ta': ((0.301961, 0.65098, 1), 1, u'default'), 'Yb': ((0, 0.74902, 0.219608), 1, u'default'), 'Db': ((0.819608, 0, 0.309804), 1, u'default'), 'Dy': ((0.121569, 1, 0.780392), 1, u'default'), 'At': ((0.458824, 0.309804, 0.270588), 1, u'default'), 'I': ((0.580392, 0, 0.580392), 1, u'default'), 'U': ((0, 0.560784, 1), 1, u'default'), 'Y': ((0.580392, 1, 1), 1, u'default'), 'Ac': ((0.439216, 0.670588, 0.980392), 1, u'default'), 'Ag': ((0.752941, 0.752941, 0.752941), 1, u'default'), 'Ir': ((0.0901961, 0.329412, 0.529412), 1, u'default'), 'Am': ((0.329412, 0.360784, 0.94902), 1, u'default'), 'Al': ((0.74902, 0.65098, 0.65098), 1, u'default'), 'As': ((0.741176, 0.501961, 0.890196), 1, u'default'), 'Ar': ((0.501961, 0.819608, 0.890196), 1, u'default'), 'Au': ((1, 0.819608, 0.137255), 1, u'default'), 'Es': ((0.701961, 0.121569, 0.831373), 1, u'default'), 'In': ((0.65098, 0.458824, 0.45098), 1, u'default'), 'Mo': ((0.329412, 0.709804, 0.709804), 1, u'default')}
	...
	viewerInfo = {'cameraAttrs': {'center': (255, 255, 255), 'fieldOfView': 16.561310471608, 'nearFar': (743.88837525694, 9.7771740850694), 'ortho': False, 'eyeSeparation': 50.8, 'focal': 255}, 'viewerAttrs': {'silhouetteColor': None, 'clipping': False, 'showSilhouette': False, 'showShadows': False, 'viewSize': 322.11685236769, 'labelsOnTop': True, 'depthCueRange': (0.5, 1), 'silhouetteWidth': 2, 'singleLayerTransparency': True, 'shadowTextureSize': 2048, 'backgroundImage': [None, 1, 2, 1, 0, 0], 'backgroundGradient': [('Chimera default', [(1, 1, 1, 1), (0, 0, 1, 1)], 1), 1, 0, 0], 'depthCue': True, 'highlight': 0, 'scaleFactor': 0.84608883479561, 'angleDependentTransparency': True, 'backgroundMethod': 0}, 'viewerHL': 2, 'cameraMode': 'mono', 'detail': 1.5, 'viewerFog': None, 'viewerBG': 1}
     ...
     (
      {
       ...
       'file_type': 'mrc',
       'grid_id': '',
       'name': '5tj6_mb_ref.mrc',
       'path': '5tj6_mb_ref.mrc',
       'rotation': (
         ( 1, 0, 0, ),
         ( 0, 1, 0, ),
         ( 0, 0, 1, ),
      ...
      [
       {
        ...
        'session_volume_id': 'z!D[^v(1_ow\x0c](SyRk9z_s[XOJxV1=\\z',
        ...
        'surface_model': {
          ...
          'xform': {
            'class': 'Xform_State',
            'rotation_angle': 149.68951440389512,
            'rotation_axis': ( -0.2656919558313081, -0.6708000581912661, -0.6924124973865855, ),
            'translation': ( 167.6642795595581, 4.350745110053108, 8.939181694279172, ),
            'version': 1,
           },
         },
     ...
     (
      {
       ...
       'file_type': 'mrc',
       'grid_id': '',
       'name': '5tj6_mbz_align.mrc',
       'path': '5tj6_mbz_align.mrc',
       'rotation': (
         ( 1, 0, 0, ),
         ( 0, 1, 0, ),
         ( 0, 0, 1, ),
      ...
      [
       {
        ...
        'representation': 'surface',
        'session_volume_id': 'j~`\tn(t"y`Vy-B\rt\n,F{R4Q\x0bs[^p[T1"',
        'solid_brightness_factor': 1.0,
        'solid_colors': [
          ( 1, 1, 0.7, 1, ),
          ( 1, 1, 0.7, 1, ),
        ...
        'surface_levels': [ 44.16280292793915, ],
        'surface_model': {
          'active': True,
          'class': 'Model_State',
          'clip_plane_normal': ( 0.0, 0.0, 0.0, ),
      ...
      [
       {
        ...
        'representation': 'surface',
        'session_volume_id': 'u8#w\r\nC!@RL\x0bSwyPadD/H@thb*y&.ffj',
        'solid_brightness_factor': 1.0,
        'solid_colors': [
          ( 1, 1, 0.7, 1, ),
          ( 1, 1, 0.7, 1, ),
        ...
        'surface_model': {
          ...
          'xform': {
            'class': 'Xform_State',
            'rotation_angle': 140.9976606421214,
            'rotation_axis': ( -0.01922056919338019, -0.9914182059839198, 0.1293078132345779, ),
            'translation': ( 119.42988054773468, 252.43845082192854, 370.44167326307445, ),
            'version': 1,
           },
         },
        'transparency_depth': 0.5,
 ...
 volume_dialog_state = \
  {
   ...
   'data_cache_size': '512',
   'focus_volume': 'j~`\tn(t"y`Vy-B\rt\n,F{R4Q\x0bs[^p[T1"',
   'geometry': u'407x496+1208+107',
   'histogram_active_order': [ 2, 1, 0, ],
   'histogram_volumes': [ 'z!D[^v(1_ow\x0c](SyRk9z_s[XOJxV1=\\z', 'u8#w\r\nC!@RL\x0bSwyPadD/H@thb*y&.ffj', 'j~`\tn(t"y`Vy-B\rt\n,F{R4Q\x0bs[^p[T1"', ],
   'immediate_update': 1,
   'initial_colors': (
     ( 0.7, 0.7, 0.7, 1, ),
     ( 1, 1, 0.7, 1, ),
