...
'Tb': ((0.188235, 1, 0.780392), 1, u'default'), 'Tc': ((0.231373, 0.619608, 0.619608), 1, u'default'), 'Ta': ((0.301961, 0.65098, 1), 1, u'default'), 'Yb': ((0, 0.74902, 0.219608), 1, u'default'), 'Db': ((0.819608, 0, 0.309804), 1, u'default'), 'Dy': ((0.121569, 1, 0.780392), 1, u'default'), 'At': ((0.458824, 0.309804, 0.270588), 1, u'default'), 'I': ((0.580392, 0, 0.580392), 1, u'default'), 'U': ((0, 0.560784, 1), 1, u'default'), 'Y': ((0.580392, 1, 1), 1, u'default'), 'Ac': ((0.439216, 0.670588, 0.980392), 1, u'default'), 'Ag': ((0.752941, 0.752941, 0.752941), 1, u'default'), 'Ir': ((0.0901961, 0.329412, 0.529412), 1, u'default'), 'Am': ((0.329412, 0.360784, 0.94902), 1, u'default'), 'Al': ((0.74902, 0.65098, 0.65098), 1, u'default'), 'As': ((0.741176, 0.501961, 0.890196), 1, u'default'), 'Ar': ((0.501961, 0.819608, 0.890196), 1, u'default'), 'Au': ((1, 0.819608, 0.137255), 1, u'default'), 'Es': ((0.701961, 0.121569, 0.831373), 1, u'default'), 'In': ((0.65098, 0.458824, 0.45098), 1, u'default'), 'Mo': ((0.329412, 0.709804, 0.709804), 1, u'default')}
	...
	viewerInfo = {'cameraAttrs': {'center': (295, 295, 295), 'fieldOfView': 16.561310471608, 'nearFar': (798.63940239069, -48.978932570247), 'ortho': False, 'eyeSeparation': 50.8, 'focal': 295}, 'viewerAttrs': {'silhouetteColor': None, 'clipping': False, 'showSilhouette': False, 'showShadows': False, 'viewSize': 372.64498607242, 'labelsOnTop': True, 'depthCueRange': (0.5, 1), 'silhouetteWidth': 2, 'singleLayerTransparency': True, 'shadowTextureSize': 2048, 'backgroundImage': [None, 1, 2, 1, 0, 0], 'backgroundGradient': [('Chimera default', [(1, 1, 1, 1), (0, 0, 1, 1)], 1), 1, 0, 0], 'depthCue': True, 'highlight': 0, 'scaleFactor': 1.1819089897831, 'angleDependentTransparency': True, 'backgroundMethod': 0}, 'viewerHL': 2, 'cameraMode': 'mono', 'detail': 1.5, 'viewerFog': None, 'viewerBG': 1}
      ...
      [
       {
        ...
        'solid_levels': [
          ( 0.0, 0, ),
          ( 0.20552938385009767, 0.99, ),
          ( 228.36598205566406, 1, ),
         ],
        'solid_model': None,
        ...
        'surface_levels': [ 41.673521010326176, ],
        'surface_model': {
          'active': True,
          'class': 'Model_State',
          ...
          'xform': {
            'class': 'Xform_State',
            'rotation_angle': 56.72948495218276,
            'rotation_axis': ( -0.7176038706514953, -0.4144263522920454, 0.5597280440999016, ),
            'translation': ( 332.31013110890154, 270.9223734796029, 353.1463372854711, ),
            'version': 1,
           },
         },
     ...
     (
      {
       ...
       'file_type': 'mrc',
       'grid_id': '',
       'name': '5gjv_mb_ref.mrc',
       'path': '5gjv_mb_ref.mrc',
       'rotation': (
         ( 1, 0, 0, ),
         ( 0, 1, 0, ),
         ( 0, 0, 1, ),
      ...
      [
       {
        ...
        'representation': 'surface',
        'session_volume_id': '3<MBLX!{8\\tiH)"%\\e\nOD\tK\x0bY:N*Z\';~',
        ...
        'surface_model': {
          ...
          'xform': {
            'class': 'Xform_State',
            'rotation_angle': 119.69035897985086,
            'rotation_axis': ( -0.595562436936005, -0.5639683468662351, -0.5720533956230074, ),
            'translation': ( 12.779320194743775, -2.251739930540544, 92.09163995713647, ),
            'version': 1,
           },
         },
        'transparency_depth': 0.5,
     ...
     (
      {
       ...
       'file_type': 'mrc',
       'grid_id': '',
       'name': '5gjv_mbz_align.mrc',
       'path': '5gjv_mbz_align.mrc',
       'rotation': (
         ( 1, 0, 0, ),
         ( 0, 1, 0, ),
         ( 0, 0, 1, ),
      ...
      [
       {
        ...
        'representation': 'surface',
        'session_volume_id': "M*;XdWTa'L5I`s\t&QMu0t B5\nK:-FW&=",
        'solid_brightness_factor': 1.0,
        'solid_colors': [
          ( 1, 1, 0.7, 1, ),
          ( 1, 1, 0.7, 1, ),
 ...
 volume_dialog_state = \
  {
   ...
   'data_cache_size': '512',
   'focus_volume': "M*;XdWTa'L5I`s\t&QMu0t B5\nK:-FW&=",
   'geometry': u'407x440+1208+107',
   'histogram_active_order': [ 2, 1, 0, ],
   'histogram_volumes': [ '3<MBLX!{8\\tiH)"%\\e\nOD\tK\x0bY:N*Z\';~', 'l\\k^Xgv\n.|/lWH~CI$>(Qk>E/vsOr;yv', "M*;XdWTa'L5I`s\t&QMu0t B5\nK:-FW&=", ],
   'immediate_update': 1,
   'initial_colors': (
     ( 0.7, 0.7, 0.7, 1, ),
     ( 1, 1, 0.7, 1, ),
