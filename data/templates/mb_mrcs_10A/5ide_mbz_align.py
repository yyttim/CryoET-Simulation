...
'Tb': ((0.188235, 1, 0.780392), 1, u'default'), 'Tc': ((0.231373, 0.619608, 0.619608), 1, u'default'), 'Ta': ((0.301961, 0.65098, 1), 1, u'default'), 'Yb': ((0, 0.74902, 0.219608), 1, u'default'), 'Db': ((0.819608, 0, 0.309804), 1, u'default'), 'Dy': ((0.121569, 1, 0.780392), 1, u'default'), 'At': ((0.458824, 0.309804, 0.270588), 1, u'default'), 'I': ((0.580392, 0, 0.580392), 1, u'default'), 'U': ((0, 0.560784, 1), 1, u'default'), 'Y': ((0.580392, 1, 1), 1, u'default'), 'Ac': ((0.439216, 0.670588, 0.980392), 1, u'default'), 'Ag': ((0.752941, 0.752941, 0.752941), 1, u'default'), 'Ir': ((0.0901961, 0.329412, 0.529412), 1, u'default'), 'Am': ((0.329412, 0.360784, 0.94902), 1, u'default'), 'Al': ((0.74902, 0.65098, 0.65098), 1, u'default'), 'As': ((0.741176, 0.501961, 0.890196), 1, u'default'), 'Ar': ((0.501961, 0.819608, 0.890196), 1, u'default'), 'Au': ((1, 0.819608, 0.137255), 1, u'default'), 'Es': ((0.701961, 0.121569, 0.831373), 1, u'default'), 'In': ((0.65098, 0.458824, 0.45098), 1, u'default'), 'Mo': ((0.329412, 0.709804, 0.709804), 1, u'default')}
	...
	viewerInfo = {'cameraAttrs': {'center': (275, 275, 275), 'fieldOfView': 16.561310471608, 'nearFar': (851.59846089998, 60.761125084553), 'ortho': False, 'eyeSeparation': 50.8, 'focal': 275}, 'viewerAttrs': {'silhouetteColor': None, 'clipping': False, 'showSilhouette': False, 'showShadows': False, 'viewSize': 484.97422611929, 'labelsOnTop': True, 'depthCueRange': (0.5, 1), 'silhouetteWidth': 2, 'singleLayerTransparency': True, 'shadowTextureSize': 2048, 'backgroundImage': [None, 1, 2, 1, 0, 0], 'backgroundGradient': [('Chimera default', [(1, 1, 1, 1), (0, 0, 1, 1)], 1), 1, 0, 0], 'depthCue': True, 'highlight': 0, 'scaleFactor': 1.39690886013, 'angleDependentTransparency': True, 'backgroundMethod': 0}, 'viewerHL': 2, 'cameraMode': 'mono', 'detail': 1.5, 'viewerFog': None, 'viewerBG': 1}
     ...
     (
      {
       ...
       'file_type': 'mrc',
       'grid_id': '',
       'name': '5ide_mbz_align.mrc',
       'path': '5ide_mbz_align.mrc',
       'rotation': (
         ( 1, 0, 0, ),
         ( 0, 1, 0, ),
         ( 0, 0, 1, ),
      ...
      [
       {
        ...
        'session_volume_id': 'd"+\x0b3Pm>#lU/pa"T;vm+*N2*e\x0cHY4,`~',
        ...
        'solid_levels': [
          ( 0.0, 0, ),
          ( 0.30895351409912108, 0.99, ),
          ( 123.58140563964844, 1, ),
         ],
        'solid_model': None,
        ...
        'surface_levels': [ 37.92068566529644, ],
        'surface_model': {
          'active': True,
          'class': 'Model_State',
          ...
          'xform': {
            'class': 'Xform_State',
            'rotation_angle': 88.6039957791976,
            'rotation_axis': ( -0.9991810448617523, -0.016335991833825232, -0.0370185758745853, ),
            'translation': ( -19.510641496862007, 32.93110541365172, 709.2283994260014, ),
            'version': 1,
           },
         },
      ...
      [
       {
        ...
        'representation': 'surface',
        'session_volume_id': 'p;k,Ax.\x0b;%]}:BTfaZ\x0c}&_-V4VV?QV"i',
        'solid_brightness_factor': 1.0,
        'solid_colors': [
          ( 1, 1, 0.7, 1, ),
          ( 1, 1, 0.7, 1, ),
        ...
        'surface_model': {
          ...
          'xform': {
            'class': 'Xform_State',
            'rotation_angle': 154.75833242629665,
            'rotation_axis': ( 0.5870296061801654, -0.7498499757079369, 0.30515775493794395, ),
            'translation': ( 272.7226664127488, 333.7310791648763, 453.6787687905329, ),
            'version': 1,
           },
         },
        'transparency_depth': 0.5,
     ...
     (
      {
       ...
       'file_type': 'mrc',
       'grid_id': '',
       'name': '5ide_mb_ref.mrc',
       'path': '5ide_mb_ref.mrc',
       'rotation': (
         ( 1, 0, 0, ),
         ( 0, 1, 0, ),
         ( 0, 0, 1, ),
      ...
      [
       {
        ...
        'representation': 'surface',
        'session_volume_id': '/~0hCp}{Mp,NX=C="o!U\t( j4=mTYG>V',
        'solid_brightness_factor': 1.0,
        'solid_colors': [
          ( 1.0, 1.0, 1.0, 1, ),
          ( 1.0, 1.0, 1.0, 1, ),
 ...
 volume_dialog_state = \
  {
   ...
   'data_cache_size': '512',
   'focus_volume': 'd"+\x0b3Pm>#lU/pa"T;vm+*N2*e\x0cHY4,`~',
   'geometry': u'407x496+1208+107',
   'histogram_active_order': [ 2, 1, 0, ],
   'histogram_volumes': [ '/~0hCp}{Mp,NX=C="o!U\t( j4=mTYG>V', 'p;k,Ax.\x0b;%]}:BTfaZ\x0c}&_-V4VV?QV"i', 'd"+\x0b3Pm>#lU/pa"T;vm+*N2*e\x0cHY4,`~', ],
   'immediate_update': 1,
   'initial_colors': (
     ( 0.7, 0.7, 0.7, 1, ),
     ( 1, 1, 0.7, 1, ),
